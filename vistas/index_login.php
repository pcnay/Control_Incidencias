...
else
{
  ...
  <head>
  	...
  	<title>Control De Incidentes </title>
  ...
  <body>
      ...
      <nav class="navbar navbar-default">
          <div class="navbar-header">
              ...
              <a href="#" class="navbar-brand">Control De Incidentes</a>
          </div>
                          ...
                          <form role="form">
                              <div class="form-group">
                                  ...
                                  <div class="input-group">
                                      ...
                                      <input type="input" class="form-control" id="usuario" placeholder="Nombre Usuario">
                                  </div>
                              </div>
                              <div class="form-group">
